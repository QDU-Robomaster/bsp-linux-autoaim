...
static void XRobotMain(LibXR::HardwareContainer &hw) {
  ...
  > camera_frame_sync(
      ...
      appmgr,
      camera,
      {CameraFrameSync<AutoAimRunConfig::HikFrameLayout>::SyncMode::RAW_PROBE, AutoAimRunConfig::HikSyncOffsetUs, "host", "camera_sync_command", "camera_sync_result", 3, 1, 100.0F}
  );
  ...
  static ArmorDetector<AutoAimRunConfig::HikFrameLayout> armor_detector(
      hw,
      appmgr,
      {2, {ArmorDetectorModel::INT16_HEAD_L, 0.1, true, 16.0}, true, "host", AutoAimRunConfig::RefereeTopicName, {false, "armor_detector_preview", 0.5, 1, 1, "window", "0.0.0.0", 8080, "armor_detector", 30.0}},
      camera_frame_sync
  );
  ...
  static Aimer<AutoAimRunConfig::HikFrameLayout> aimer(
      hw,
      appmgr,
      {0.0, 0.6, 2.0, 21.7, 14.0, 0.02, 0.001, 16, -20.0, 35.0, true, 0.0, 0.0, 0.0, 0.0, 0.05, 0.075, 0.075, 0.06, 0.48, true, 0.48, 50.0, 9000000.0, 0.0, 1.0, 100.0, 9000000.0, 0.0, 1.0, {false, "aimer_preview", 0.5, 1, 1, "window", "0.0.0.0", 8080, "aimer_preview", 30.0}, true, 0.05, 1.0, true, AutoAimRunConfig::RefereeTopicName},
      AutoAimRunConfig::MainCameraCalibration
  );
